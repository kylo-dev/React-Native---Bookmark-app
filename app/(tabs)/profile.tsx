...
import { signOut, useAuth, updateUserName } from '@/lib/auth';
...
export default function ProfileScreen() {
    ...
    const fetchUserProfile = async () => {
        ...
        if (user) {
            setEditName(user.user_metadata?.name || 'User');
        ...
        Alert.alert(
            ...
            [
                { text: 'Cancel', style: 'cancel' },
                {
                    text: 'Delete',
                    style: 'destructive',
                    onPress: () => Alert.alert('Account Deleted', 'Your data has been cleared. (Dummy)'),
                },
            ],
        );
    };
                    ...
                    <ScrollView style={styles.modalContent} keyboardShouldPersistTaps="handled">
                        ...
                        <View style={styles.dangerZone}>
                            ...
                            <Text style={styles.dangerZoneDesc}>
                                Permanently delete your account and all data. This cannot be recovered.
                            </Text>
                        </View>
                    </ScrollView>
                </View>
